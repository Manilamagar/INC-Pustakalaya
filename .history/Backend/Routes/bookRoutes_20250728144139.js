...
import {getBooks,borrowBooks,searchBooks,viewBooks,addBooks, updateBooks, deleteBooks, editBooks, issuesBooks, returnBooks} from '../Controllers/booksController.js';
const router = express.Router();

router.get('/', getBooks);
router.post('/borrow', borrowBooks);
router.get('/search', getBooks);
 // Assuming search functionality is handled in getBooks
