...
const { getBooks, borrowBooks, listBooks, searchBooks, viewBooks, updateBooks, deleteBooks, editBooks, issuesBooks, returnBooks } = require('../Controllers/booksController');
